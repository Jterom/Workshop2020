...
<html>
    <head>
        ...
        <link href="src/css/actualite.css" rel="stylesheet" type="text/css"/>
        ...
        <!--API GOOGLE MAP-->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCSrm7R9hG5hwrHtFllSa1ICmgQtB12tjA&callback=initMap&libraries=&v=weekly" defer></script>
